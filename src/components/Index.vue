    ...
    <div class="index-vue">
        ...
        <aside :class="asideClassName">
            ...
            <div class="logo-c">
                ...
                <span v-show="isShowAsideTitle">三友</span>
            </div>
            <!-- 菜单栏 -->
        ...
        <el-dialog title="修改密码" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
            <el-form :model="form" label-width="120px">
                ...
                <el-input v-model="form.newPwd1" show-password></el-input>
                </el-form-item>
            ...
            <span slot="footer" class="dialog-footer">
                <el-button type="primary" @click="dialogVisible = false;updatePwd()">提 交</el-button>
...
export default {
    ...
    methods: {
        ...
        updatePwd(){
            ...
            let newPwd1 = this.form.newPwd1;
            let newPwd2 = this.form.newPwd2;
